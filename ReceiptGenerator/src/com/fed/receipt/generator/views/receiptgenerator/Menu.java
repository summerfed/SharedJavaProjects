...
import com.fed.receipt.generator.db.views.AddProductFrame;
import com.fed.receipt.generator.db.views.AddProductTable;
import com.fed.receipt.generator.printer.Printer;

class Menu {
	private static final String MENU_ITEM_ADD_PRODUCTS = "Add Products";
	/**
	 * 
	 */
	...
	public Menu() {
		...
		JMenuItem subMenuAddProducts = new JMenuItem(MENU_ITEM_ADD_PRODUCTS);
	...
	public void addMenuItemEvent(JMenuItem component) {
		component.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				JMenuItem eventSourceComponent = (JMenuItem) event.getSource();
				String menuText = eventSourceComponent.getText();
				if(menuText.equals(MENU_ITEM_ADD_PRODUCTS)) {
					AddProductFrame.showView();
				}
			}
		});
