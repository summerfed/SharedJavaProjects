...
public class AddProductTableModel extends AbstractTableModel{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1446583813673830241L;
	private String[] columns = {"Unit", "Description", "Unit Price", "Amount"};
	private AddProductTableData data;
	private Class<?>[] columnClasses = TableConstants.COLUMN_CLASSES;
	
	public AddProductTableModel(AddProductTableData data) {
		this.data = data;
