...
public class DataUtilities {
	...
	public static int getIntPercentage(int value, float percentage) {
		int k = (int)(value*(percentage/100.0f));
		return k;
	}
	
	public static float getFloatPercentage(float value, float percentage) {
		float k = (value*(percentage/100.0f));
		return k;
	}
}