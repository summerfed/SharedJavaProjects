...
public class ExceptionNodePanel extends Composite{
		...
		addNodeBtn.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				if(addNodeBtn.isEnable()){
					...
					InsertExceptionNodeTextBoxes first = new InsertExceptionNodeTextBoxes();
...
//	}
	...
	public InsertExceptionNodePanel getAddNodePnl() {
		return addNodePnl;
	}
