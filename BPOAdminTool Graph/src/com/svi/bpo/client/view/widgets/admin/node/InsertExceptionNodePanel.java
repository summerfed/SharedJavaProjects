...
public class InsertExceptionNodePanel extends Composite {
	...
	private InsertExceptionNodeTextBoxes textBox;
	
	public InsertExceptionNodePanel() {
		...
		textBox = new InsertExceptionNodeTextBoxes();
	...
	public List<ExceptionDtlObj> getListOfExceptionNodesObjToBeAdded() {

		List<ExceptionDtlObj> nodes = new ArrayList<ExceptionDtlObj>();

		for (Widget widget : txtBxWidgetPnl) {
			if (widget instanceof InsertExceptionNodeTextBoxes) {
				// NodeDtlObj nodeObj = new
				// NodeDtlObj(((AddNodeTextBoxes)widget).getNodeIdTxtBx().getText(),
				// ((AddNodeTextBoxes)widget).getNodeDescTxtBx().getText(),
				// ((AddNodeTextBoxes)widget).getSelectedEndpoint(),
				// null,
				// null);
			 ...
			 * */
				InsertExceptionNodeTextBoxes txbx = (InsertExceptionNodeTextBoxes) widget;
				if (txbx.getExceptionCodeTextbox().getText().equals("")
						|| txbx.getExceptionNameTextBox().getText().equals("")
						|| txbx.getNodeIdTextbox().getText().equals("")) {
					return null;
				}
	
				ExceptionDtlObj nodeObj = new ExceptionDtlObj(txbx.getNodeIdTextbox().getText(),txbx.getExceptionNameTextBox().getText(),
						txbx.getExceptionCodeTextbox().getText(),Integer.parseInt(toInt(txbx.getAllowedWaitingDurationTxtbxTextbox().getText())),
						Integer.parseInt(toInt(txbx.getAllowedProcessDurationTxtbxTextbox().getText())),
						Integer.parseInt(toInt(txbx.getCurrentTotalWaitingElementsTxtbxTextbox().getText())),
						Integer.parseInt(toInt(txbx.getCurrentTotalInProcessElementsTxtbxTextbox().getText())));
				nodes.add(nodeObj);
				
//				NodeDtlObj nodeObj = new NodeDtlObj();
				
			//	public ExceptionDtlObj(String exceptionName, String exceptionCode,
...
//				nodes.add(nodeObj);
	...
	public InsertExceptionNodeTextBoxes getTextBox() {
		return textBox;
	}

	public void setTextBox(InsertExceptionNodeTextBoxes textBox) {
