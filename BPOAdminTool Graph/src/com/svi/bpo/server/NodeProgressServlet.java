...
public class NodeProgressServlet extends HttpServlet {	


	
//	private static final String PERCENT_OUTPUT = "percentage output";
//	private static final String PERCENT_ERROR = "percentage error";
	private static final String NODE_PROGRESS = "nodeProgress";
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5395312229822800966L;
...
//					System.err.println("Output Count: " + outputCnt);
					int targetOutput = (int) each.get("targetOutput");
					...
					try {
						...
						float nodeProgress = (float) ((outputCnt+errorCnt)*100) / targetOutput ;
						
						System.out.println("PROGRESS: " + String.format("%.2f",nodeProgress));
...
//						dataObj.put(PERCENT_ERROR, String.format("%.2f",percentError));
						dataObj.put(NODE_PROGRESS, String.format("%.2f",nodeProgress));
